...
#  * sample_names: names of specific samples (e.g., SS5_Teeth_1_a)
#  * control_names: names of specific control samples (e.g., SS5_Teeth_1_Control_a)
...
```{r Teeth1}
load("/home/wburr/Rushali_Analysis/New_Stuff/Teeth/Teeth1n.rda")
Teeth1m$PeakSN<-as.numeric(Teeth1m$PeakSN)
Teeth1m$Sample <- str_replace_all(Teeth1m$Sample, " ", "_")

Teeth1SS2 <- join_common( clean_common(Teeth1m,
                sample_names = c("SS2Teeth1a", "SS2Teeth1b"),
                control_names = c("SS2Teeth1Control"),
                ratio_par = 2.0) )
Teeth1SS3 <- join_common( clean_common(Teeth1m,
                sample_names = c("SS3Teeth1a", "SS3Teeth1b", "SS3Teeth1c"),
                control_names = c("SS3Teeth1Control"),
                ratio_par = 2.0) )
Teeth1SS4 <- join_common( clean_common(Teeth1m,
                sample_names = c("SS4Teeth1a", "SS4Teeth1b", "SS4Teeth1c"),
                control_names = c("SS4Teeth1Control_a", "SS4Teeth1Control_b", "SS4Teeth1Control_c"),
                ratio_par = 2.0) )
```
...
```{r}
all_SS <- vector("list", 3)
all_SS[[1]] <- Teeth1SS2
all_SS[[2]] <- Teeth1SS3
all_SS[[3]] <- Teeth1SS4
names(all_SS) <- c(paste0("Teeth1SS", 2:4))
save(file = "/home/wburr/Rushali_Analysis/New_Stuff/Teeth/all_SS_PCA.rda", all_SS)
rm(list = ls())
load("/home/wburr/Rushali_Analysis/New_Stuff/Teeth/all_SS_PCA.rda")
```
...
So there are 267 unique compounds present across the 3
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_Analysis/New_Stuff/Teeth/all_teeth_cleaned.xlsx",
...
Then, let's create a set of vectors, 3 in total.
```{r}
...
write.csv(file = "pca_ready_Teeth.csv", pca_dat)
```
