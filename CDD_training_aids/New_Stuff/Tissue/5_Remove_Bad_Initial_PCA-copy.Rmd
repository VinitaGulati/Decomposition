...
#  * sample_names: names of specific samples (e.g., SS5_Tissue_1_a)
#  * control_names: names of specific control samples (e.g., SS5_Tissue_1_Control_a)
...
# Working Through All the Tissue

```{r Tissue1}
load("/home/wburr/Rushali_Analysis/New_Stuff/Tissue/Tissue1n.rda")
Tissue1m$PeakSN<-as.numeric(Tissue1m$PeakSN)
Tissue1m$Sample <- str_replace_all(Tissue1m$Sample, " ", "_")

Tissue1_SS2 <- join_common( clean_common(Tissue1m,
                sample_names = c("SS2Tissue1a", "SS2Tissue1b"),
                control_names = c("SS2Tissue1Control"),
                ratio_par = 2.0) )
Tissue1_SS3 <- join_common( clean_common(Tissue1m,
                sample_names = c("SS3Tissue1a", "SS3Tissue1b", "SS3Tissue1c"),
                control_names = c("SS3Tissue1Control"),
                ratio_par = 2.0) )
Tissue1_SS4 <- join_common( clean_common(Tissue1m,
                sample_names = c("SS4Tissue1a", "SS4Tissue1b", "SS4Tissue1c"),
                control_names = c("SS4Tissue1Control_a", "SS4Tissue1Control_b", "SS4Tissue1Control_c"),
                ratio_par = 2.0) )
Tissue1_SS5 <- join_common( clean_common(Tissue1m,
                sample_names = c("SS5Tissue1a", "SS5Tissue1b", "SS5Tissue1c"),
                control_names = c("SS5Tissue1Control_a", "SS5Tissue1Control_b", "SS5Tissue1Control_c"),
                ratio_par = 2.0) )
Tissue1_SS6 <- join_common( clean_common(Tissue1m,
                sample_names = c("SS6Tissue1a", "SS6Tissue1b", "SS6Tissue1c"),
                control_names = c("SS6Tissue1Control_a", "SS6Tissue1Control_b", "SS6Tissue1Control_c"),
                ratio_par = 2.0) )
```

```{r Tissue2}
load("/home/wburr/Rushali_Analysis/New_Stuff/Tissue/Tissue2n.rda")
Tissue2m$PeakSN<-as.numeric(Tissue2m$PeakSN)
Tissue2m$Sample <- str_replace_all(Tissue2m$Sample, " ", "_")

Tissue2_SS2 <- join_common( clean_common(Tissue2m,
                sample_names = c("SS2Tissue2a", "SS2Tissue2b"),
                control_names = c("SS2Tissue2Control"),
                ratio_par = 2.0) )
Tissue2_SS3 <- join_common( clean_common(Tissue2m,
                sample_names = c("SS3Tissue2a", "SS3Tissue2b", "SS3Tissue2c"),
                control_names = c("SS3Tissue2Control"),
                ratio_par = 2.0) )
Tissue2_SS4 <- join_common( clean_common(Tissue2m,
                sample_names = c("SS4Tissue2a", "SS4Tissue2b", "SS4Tissue2c"),
                control_names = c("SS4Tissue2Control_a", "SS4Tissue2Control_b", "SS4Tissue2Control_c"),
                ratio_par = 2.0) )
Tissue2_SS5 <- join_common( clean_common(Tissue2m,
                sample_names = c("SS5Tissue2a", "SS5Tissue2b", "SS5Tissue2c"),
                control_names = c("SS5Tissue2Control_a", "SS5Tissue2Control_b", "SS5Tissue2Control_c"),
                ratio_par = 2.0) )
Tissue2_SS6 <- join_common( clean_common(Tissue2m,
                sample_names = c("SS6Tissue2a", "SS6Tissue2b"),
                control_names = c("SS6Tissue2Control_a", "SS6Tissue2Control_b", "SS6Tissue2Control_c"),
                ratio_par = 2.0) )
```

```{r Tissue3}
load("/home/wburr/Rushali_Analysis/New_Stuff/Tissue/Tissue3n.rda")
Tissue3m$PeakSN<-as.numeric(Tissue3m$PeakSN)
Tissue3m$Sample <- str_replace_all(Tissue3m$Sample, " ", "_")


Tissue3_SS5 <- join_common( clean_common(Tissue3m,
                sample_names = c("SS5Tissue3a", "SS5Tissue3b", "SS5Tissue3c"),
                control_names = c("SS5Tissue3Control_a", "SS5Tissue3Control_b", "SS5Tissue3Control_c"),
                ratio_par = 2.0) )
Tissue3_SS6 <- join_common( clean_common(Tissue3m,
                sample_names = c("SS6Tissue3a", "SS6Tissue3b", "SS6Tissue3c"),
                control_names = c("SS6Tissue3Control_a", "SS6Tissue3Control_b", "SS6Tissue3Control_c"),
                ratio_par = 2.0) )
```
...
all_SS[[1]] <- Tissue1_SS2
all_SS[[2]] <- Tissue1_SS3
all_SS[[3]] <- Tissue1_SS4
all_SS[[4]] <- Tissue1_SS5
all_SS[[5]] <- Tissue1_SS6
all_SS[[6]] <- Tissue2_SS2
all_SS[[7]] <- Tissue2_SS3
all_SS[[8]] <- Tissue2_SS4
all_SS[[9]] <- Tissue2_SS5
all_SS[[10]] <- Tissue2_SS6
all_SS[[11]] <- Tissue3_SS5
all_SS[[12]] <- Tissue3_SS6
names(all_SS) <- c(paste0("Tissue1_SS", 2:6 ),
                   paste0("Tissue2_SS", 2:6),
                   paste0("Tissue3_SS", 5:6))
save(file = "/home/wburr/Rushali_Analysis/New_Stuff/Tissue/all_SS_PCA.rda", all_SS)
rm(list = ls())
load("/home/wburr/Rushali_Analysis/New_Stuff/Tissue/all_SS_PCA.rda")
```
...
So there are 576 unique compounds present across the 12
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_Analysis/New_Stuff/Tissue/all_Tissue_cleaned.xlsx",
...
write.csv(file = "pca_ready_tissue.csv", pca_dat)
```
