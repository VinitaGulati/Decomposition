...
```{r FootR}
load("/home/wburr/Rushali_Analysis/New_Stuff/Foot R/FootRn.rda")
FootR1m$PeakSN<-as.numeric(FootR1m$PeakSN)
FootR1m$Sample <- str_replace_all(FootR1m$Sample, " ", "_")

FootR_SS3 <- join_common( clean_common(FootR1m,
                sample_names = c("SS3FootR_a", "SS3FootR_b", "SS3FootR_c"),
                control_names = c("SS3FootRControl_a","SS3FootRControl_b" ),
                ratio_par = 2.0) )
FootR_SS4 <- join_common( clean_common(FootR1m,
                sample_names = c("SS4FootR_a", "SS4FootR_b"),
                control_names = c("SS4FootRControl_a", "SS4FootRControl_b"),
                ratio_par = 2.0) )
FootR_SS6 <- join_common( clean_common(FootR1m,
                sample_names = c("SS6FootR_a", "SS6FootR_b"),
                control_names = c("SS6FootRControl_a", "SS6FootRControl_b"),
                ratio_par = 2.0) )
```
...
all_SS[[2]] <- FootR_SS4
all_SS[[3]] <- FootR_SS6
names(all_SS) <- c(paste0("FootR_SS3"),
                  paste0("FootR_SS4"),
                  paste0("FootR_SS6"))
save(file = "/home/wburr/Rushali_Analysis/New_Stuff/Foot R/all_SS_PCA.rda", all_SS)
rm(list = ls())
load("/home/wburr/Rushali_Analysis/New_Stuff/Foot R/all_SS_PCA.rda")
```
...
So there are 99 unique compounds present across the 3
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_Analysis/New_Stuff/Foot R/all_FootR_cleaned.xlsx",
...
write.csv(file = "pca_ready_FootR.csv", pca_dat)
```
