...
#  * control_names: names of specific control samples (e.g., Control_D1ad0)
...
```{r Donor10}
load("/home/wburr/Rushali_REST/Donor10/D10n.rda")
D10m$PeakSN<-as.numeric(D10m$PeakSN)
D10m$Sample <- str_replace_all(D10m$Sample, " ", "_")

D10d0 <- join_common( clean_common(D10m,
                sample_names = c("D10ad0", "D10bd0", "D10cd0"),
                control_names = c("Control_D10d0"),
                ratio_par = 2.0) )
D10d1 <- join_common( clean_common(D10m,
                sample_names = c("D10ad1", "D10bd1", "D10cd1"),
                control_names = c("Control_D10d1"),
                ratio_par = 2.0) )
D10d2 <- join_common( clean_common(D10m,
                sample_names = c("D10ad2", "D10bd2", "D10cd2"),
                control_names = c("Control_D10d2"),
                ratio_par = 2.0) )
D10d3 <- join_common( clean_common(D10m,
                sample_names = c("D10ad3", "D10bd3", "D10cd3"),
                control_names = c("Control_D10d3"),
                ratio_par = 2.0) )
D10d4 <- join_common( clean_common(D10m,
                sample_names = c("D10ad4", "D10bd4", "D10cd4"),
                control_names = c("Control_D10d4"),
                ratio_par = 2.0) )
D10d6 <- join_common( clean_common(D10m,
                sample_names = c("D10ad6", "D10bd6", "D10cd6"),
                control_names = c("Control_D10d6"),
                ratio_par = 2.0) )
D10d9 <- join_common( clean_common(D10m,
                sample_names = c("D10ad9", "D10bd9", "D10cd9"),
                control_names = c("Control_D10d9"),
                ratio_par = 2.0) )
D10d11 <- join_common( clean_common(D10m,
                sample_names = c("D10ad11", "D10bd11", "D10cd11"),
                control_names = c("Control_D10d11"),
                ratio_par = 2.0) )
D10d13 <- join_common( clean_common(D10m,
                sample_names = c("D10ad13", "D10bd13", "D10cd13"),
                control_names = c("Control_D10d13"),
                ratio_par = 2.0) )
D10d16 <- join_common( clean_common(D10m,
                sample_names = c("D10ad16", "D10bd16", "D10cd16"),
                control_names = c("Control_D10d16"),
                ratio_par = 2.0) )
D10d18 <- join_common( clean_common(D10m,
                sample_names = c("D10ad18", "D10bd18", "D10cd18"),
                control_names = c("Control_D10d18"),
                ratio_par = 2.0) )
D10d20 <- join_common( clean_common(D10m,
                sample_names = c("D10ad20", "D10bd20", "D10cd20"),
                control_names = c("Control_D10d20"),
                ratio_par = 2.0) )
D10d24 <- join_common( clean_common(D10m,
                sample_names = c("D10ad24", "D10bd24", "D10cd24"),
                control_names = c("Control_D10d24"),
                ratio_par = 2.0) )
D10d27 <- join_common( clean_common(D10m,
                sample_names = c("D10ad27", "D10bd27", "D10cd27"),
                control_names = c("Control_D10d27"),
                ratio_par = 2.0) )
D10d30 <- join_common( clean_common(D10m,
                sample_names = c("D10ad30", "D10bd30", "D10cd30"),
                control_names = c("Control_D10d30"),
                ratio_par = 2.0) )
D10d34 <- join_common( clean_common(D10m,
                sample_names = c("D10ad34", "D10bd34", "D10cd34"),
                control_names = c("Control_D10d34"),
                ratio_par = 2.0) )
```
...
names(all_d) <- c(paste0("D10d0"),
                  ...
                  paste0("D10d30"),
                  paste0("D10d34"))
save(file = "/home/wburr/Rushali_REST/Donor10/all_D10_PCA_noIS.rda", all_d)
rm(list = ls())
load("/home/wburr/Rushali_REST/Donor10/all_D10_PCA_noIS.rda")
```
...
So there are 329 unique compounds present across the
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_REST/Donor10/all_D10_cleaned_noIS.xlsx",
...
Then, let's create a set of vectors, 16 in total.
...
write.csv(file = "pca_ready_D10_noIS.csv", pca_dat)
```
