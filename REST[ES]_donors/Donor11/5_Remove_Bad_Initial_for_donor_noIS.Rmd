...
```{r Donor11}
load("/home/wburr/Rushali_REST/Donor11/D11n.rda")
D11m$PeakSN<-as.numeric(D11m$PeakSN)
D11m$Sample <- str_replace_all(D11m$Sample, " ", "_")

D11d0 <- join_common( clean_common(D11m,
                sample_names = c("D11ad0", "D11bd0", "D11cd0"),
                control_names = c("Control_D11d0"),
                ratio_par = 2.0) )
D11d1 <- join_common( clean_common(D11m,
                sample_names = c("D11ad1", "D11bd1", "D11cd1"),
                control_names = c("Control_D11d1"),
                ratio_par = 2.0) )
D11d2 <- join_common( clean_common(D11m,
                sample_names = c("D11ad2", "D11bd2"),
                control_names = c("Control_D11d2"),
                ratio_par = 2.0) )
D11d3 <- join_common( clean_common(D11m,
                sample_names = c("D11ad3", "D11bd3", "D11cd3"),
                control_names = c("Control_D11d3"),
                ratio_par = 2.0) )
D11d6 <- join_common( clean_common(D11m,
                sample_names = c("D11ad6", "D11bd6", "D11cd6"),
                control_names = c("Control_D11d6"),
                ratio_par = 2.0) )
D11d8 <- join_common( clean_common(D11m,
                sample_names = c("D11ad8", "D11bd8", "D11cd8"),
                control_names = c("Control_D11d8"),
                ratio_par = 2.0) )
D11d10 <- join_common( clean_common(D11m,
                sample_names = c("D11ad10", "D11bd10", "D11cd10"),
                control_names = c("Control_D11d10"),
                ratio_par = 2.0) )
D11d14 <- join_common( clean_common(D11m,
                sample_names = c("D11ad14", "D11bd14", "D11cd14"),
                control_names = c("Control_D11d14"),
                ratio_par = 2.0) )
D11d17 <- join_common( clean_common(D11m,
                sample_names = c("D11ad17", "D11bd17", "D11cd17"),
                control_names = c("Control_D11d17"),
                ratio_par = 2.0) )
D11d20 <- join_common( clean_common(D11m,
                sample_names = c("D11ad20", "D11bd20", "D11cd20"),
                control_names = c("Control_D11d20"),
                ratio_par = 2.0) )
D11d24 <- join_common( clean_common(D11m,
                sample_names = c("D11ad24", "D11bd24", "D11cd24"),
                control_names = c("Control_D11d24"),
                ratio_par = 2.0) )
D11d27 <- join_common( clean_common(D11m,
                sample_names = c("D11ad27", "D11bd27", "D11cd27"),
                control_names = c("Control_D11d27"),
                ratio_par = 2.0) )
D11d30 <- join_common( clean_common(D11m,
                sample_names = c("D11ad30", "D11bd30", "D11cd30"),
                control_names = c("Control_D11d30"),
                ratio_par = 2.0) )
```
...
names(all_d) <- c(paste0("D11d0"),
                  ...
                  paste0("D11d27"),
                  paste0("D11d30"))
save(file = "/home/wburr/Rushali_REST/Donor11/all_D11_PCA_noIS.rda", all_d)
rm(list = ls())
load("/home/wburr/Rushali_REST/Donor11/all_D11_PCA_noIS.rda")
```
...
So there are 299 unique compounds present across the 
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_REST/Donor11/all_D11_cleaned_noIS.xlsx",
...
Then, let's create a set of vectors, 13 in total.
...
write.csv(file = "pca_ready_D11_noIS.csv", pca_dat)
```
