...
```{r Donor4}
load("/home/wburr/Rushali_REST/Donor4/D4n.rda")
D4m$PeakSN<-as.numeric(D4m$PeakSN)
D4m$Sample <- str_replace_all(D4m$Sample, " ", "_")

D4d0 <- join_common( clean_common(D4m,
                sample_names = c("D4ad0", "D4bd0", "D4cd0"),
                control_names = c("Control_D4d0"),
                ratio_par = 2.0) )
D4d1 <- join_common( clean_common(D4m,
                sample_names = c("D4ad1", "D4bd1", "D4cd1"),
                control_names = c("Control_D4d1"),
                ratio_par = 2.0) )
D4d3 <- join_common( clean_common(D4m,
                sample_names = c("D4ad3", "D4bd3", "D4cd3"),
                control_names = c("Control_D4d3"),
                ratio_par = 2.0) )
D4d4 <- join_common( clean_common(D4m,
                sample_names = c("D4ad4", "D4bd4", "D4cd4"),
                control_names = c("Control_D4d4"),
                ratio_par = 2.0) )
D4d7 <- join_common( clean_common(D4m,
                sample_names = c("D4ad7", "D4bd7", "D4cd7"),
                control_names = c("Control_D4d7"),
                ratio_par = 2.0) )
D4d9 <- join_common( clean_common(D4m,
                sample_names = c("D4ad9", "D4bd9", "D4cd9"),
                control_names = c("Control_D4d9"),
                ratio_par = 2.0) )
D4d12 <- join_common( clean_common(D4m,
                sample_names = c("D4ad12", "D4bd12", "D4cd12"),
                control_names = c("Control_D4d12"),
                ratio_par = 2.0) )
D4d31 <- join_common( clean_common(D4m,
                sample_names = c("D4ad31", "D4bd31", "D4cd31"),
                control_names = c("Control_D4d31"),
                ratio_par = 2.0) )
```
...
names(all_d) <- c(paste0("D4d0"),
                  ...
                  paste0("D4d12"),
                  paste0("D4d31"))
save(file = "/home/wburr/Rushali_REST/Donor4/all_D4_PCA_noIS.rda", all_d)
rm(list = ls())
load("/home/wburr/Rushali_REST/Donor4/all_D4_PCA_noIS.rda")
```
...
So there are 154 unique compounds present across the
...
names(test)[1]
write.xlsx(x = test[[1]],
           file = "/home/wburr/Rushali_REST/Donor4/all_D4_cleaned_noIS.xlsx",
...
Then, let's create a set of vectors, 8 in total.
...
write.csv(file = "pca_ready_D4_noIS.csv", pca_dat)
```
