...
```{r}
load("/home/wburr/Rushali_REST/Donor4/D4.rda")
D4m$Area<-as.numeric(D4m$Area)
bromo <- D4m %>% 
           group_by(Sample) %>% 
...
D4m <- do.call("rbind", split_Donor)
save(file = "/home/wburr/Rushali_REST/Donor4/D4n.rda", D4m)
```
