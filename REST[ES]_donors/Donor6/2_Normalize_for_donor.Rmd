...
```{r}
load("/home/wburr/Rushali_REST/Donor6/D6.rda")
D6m$Area<-as.numeric(D6m$Area)
bromo <- D6m %>% 
           group_by(Sample) %>% 
...
D6m <- do.call("rbind", split_Donor)
save(file = "/home/wburr/Rushali_REST/Donor6/D6n.rda", D6m)
```
